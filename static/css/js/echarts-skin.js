(function (root, factory) {
    ...
    var topGrid = 5; //距离顶部距离
    var bottomGrid = 5; //距离底部距离
    var containLabel = true; //grid区域是否包含坐标轴的刻度标签

    //标题
    var colorTitle = "#666666"; //主标题颜色
    var fontSizeTitle = 16; //主标题大小
    var colorSubTitle = "#666666"; //主标题颜色
    var fontSizeSubTitle = 14; //主标题大小
    var leftTitle = 15;//主标题距离左侧距离，标题自带5px留白
    var topTitle = 0;//主标题距离顶部距离，标题自带5px留白

    //图例
    var colorLegend = "#666666"; //图例文字颜色
    var leftLegend = "center";
    var rightLegend = "auto";
    var topLegend = -5;
    ...
    var colorAxisLineLine = "#EDEDED"; //轴线颜色

    var showAxisLineLable = true; //是否显示标签
    var colorAxisLineLable = "#999"; //标签颜色
    ...
    var colorAxisLineSplitLine = ['#F5F7FA']; //分割线颜色 40485D
    ...
    var colorValueLineLine = "#EDEDED"; //轴线颜色

    var showValueLineLable = true; //是否显示标签
    var colorValueLineLable = "#999"; //标签颜色
    ...
    var colorValueLineSplitLine = ["#EDEDED"]; //分割线颜色
    var colorValueLineSplitLineType = "dahsed"; //分割线类型
