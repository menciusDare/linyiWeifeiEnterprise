        ...
        <div class="main-top">
            <div class="breadcrumb">
                <a href="#"><i class="icon icon-shenbaodengji menu-icon"></i>数据管理</a><span class="sep">&gt;</span><span
                    class="text-primary">删除数据记录</span>
            </div>
        </div>
                ...
                <div class="filter-more">
                    <ul class="filter-box">
                        ...
                        <li class="filter-item" >
                            ...
                            <div class="filter-con">
                                    <input class="el-input__inner" style="height: 35px;width: 245px" autocomplete="off"  v-model="entName" placeholder="危废名称、危废代码"></input>
                            </div>
                        </li>
                        <li class="filter-item">
           ...
           <!--                     <button type="button" class="button-type" @click="openDialog(null)">
            ...
            <table class="table-default" >
                ...
                <tr v-for="(item,index)  in tableData">
                    ...
                    <td style="text-align:center;text-overflow: ellipsis;white-space:nowrap;overflow:hidden;width: 8%" :title="item.statusName">{{item.statusName}}</td>
                </tr>
                </tbody>
            </table>
