    ...
    <div class="main">
        <div class="main-top">
            <div class="breadcrumb">
                <a href="#"><i class="icon icon-zhuanyun"></i><span class="text-primary-font">五联单查询</span></a><span class="sep">></span><span class="text-primary">跨省五联单查询</span>
            </div>
        </div>
        <div class="panel">
            ...
            <table class="table-default">
                ...
                <tr v-for="(item,i)  in tableDatas" v-if="tableDatas.length>0">
                    <td style="width: 80px">{{item.index}}</td>
                    <td :title="item.linkedId">{{item.linkedId}}</td>
                    <td :title="item.plannedTransferTime">{{item.plannedTransferTime}}</td>
                    <td :title="item.hazardousWasteCode">{{item.hazardousWasteCode}}</td>
                    <td :title="item.detailsName">{{item.detailsName}}</td>
                    <td :title="item.amount">{{item.amount}}</td>
                    <td :title="item.wasteProductionEnt">{{item.wasteProductionEnt}}</td>
                    <td :title="item.transportationEnt">{{item.transportationEnt}}</td>
                    <td :title="item.receivingEnt">{{item.receivingEnt}}</td>
                    <td :title="item.statusName"><div :class="item.statusClass">{{item.statusName}}</div></td>
                    <td :title="item.completionTime">{{item.completionTime}}</td>
