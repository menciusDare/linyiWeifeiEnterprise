    ...
    <div class="main">
                            ...
                            <div class="panel-hd">
                                <div style="">
                                    <el-form :inline="true" class="demo-form-inline">
                                        ...
                                        <el-form-item style="float: right;height: 50px; display:flex;align-items:stretch" label="押运员姓名:">
                                            <el-input  v-model="name" placeholder="请输入押运员姓名"   style="width: 145px;" ></el-input>
                                        </el-form-item>
        ...
        <!--列表-->
            ...
            <tr>
                ...
                <th style="text-align:center">押运员姓名</th>
        ...
        <!--<dialog class="setCarDialog" style="display: none;width:870px;height: 600px ;position: absolute; left: 0%; top: 15%; padding-left: 20px ;padding-top: 50px"  >-->
         <el-dialog title="分配车辆"  width="600px" max-height="870px" :visible.sync="dialogDriver" 
         :destroy-on-close="true" :modal-append-to-body="false"   :modal="false">
             <template>
        ...
        <addSupercargo v-on:close="closeAdd" ref="myFirstchild"></addSupercargo>
    </div>
</template>

<script>
    import  addSupercargo from "./addSupercargo";
    import connectEnt from "./connectEnt";
    import setCar from "./setCar";
    export default {
        components:{
            addSupercargo,connectEnt,setCar
        },
        name: "SupercargoList",
        data(){
            return{
        ...
        methods:{
            ...
            addDriver(){
                ...
                this.$refs.myFirstchild.titleName = "新增押运员";
            ...
            updateByid(id){
                ...
                this.$refs.myFirstchild.titleName = "编辑押运员";
