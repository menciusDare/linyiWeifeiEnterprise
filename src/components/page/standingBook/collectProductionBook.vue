    ...
    <div class="panel">
      <div class="panel-bd pdtlr-0">
        <div class="breadcrumb" style="width: 95%">
          ...
          <!-- <el-button type="primary" size="mini" @click="exportExcel" style="float:right">
      ...
      <div class="main-container">
        <el-tabs v-model="activeName" @tab-click="handleClick">
          ...
          <el-tab-pane label="转移台账" name="third" v-if="true">
            <table class="table-default" v-if="true">
              <thead>
                <tr>
                  <th style="text-align: center; width: 6%">序号</th>
...
export default {
  ...
  methods: {
    ...
    backPage() {
      this.$router.push({ name: "collectEnterpriseMonitor" });
    },
    details(item, type) {
