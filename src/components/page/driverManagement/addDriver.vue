    ...
    <div >
        ...
        <div >
            <el-form :model="driverForm" :rules="driverFormrules"  ref="driverForm"   class="demo-ruleForm" >
                ...
                <tr>
                    <td>
                        <el-form-item label="准驾证号" prop="driveNo" class="lableWidthClass" label-width="130px">
                            <el-input v-model="driverForm.driveNo" placeholder="请输入准驾证号" style = "width: 240px"></el-input>
                        </el-form-item>
                    </td>
                    <td>
                ...
                <tr>
                    <td>
                        <el-form-item label="准驾等级" prop="driveLevel" class="lableWidthClass" label-width="130px">
                            <el-select v-model="driverForm.driveLevel" placeholder="请选择" style="width: 240px">
                                <el-option key="A1" label="A1" value="A1"></el-option>
                                <el-option key="A2" label="A2" value="A2"></el-option>
                                <el-option key="A3" label="A3" value="A3"></el-option>
                                <el-option key="B1" label="B1" value="B1"></el-option>
                                <el-option key="B2" label="B2" value="B2"></el-option>
                                <el-option key="C1" label="C1" value="C1"></el-option>
                                <el-option key="C2" label="C2" value="C2"></el-option>
                                <el-option key="C3" label="C3" value="C3"></el-option>
                                <el-option key="C4" label="C4" value="C4"></el-option>
                                <el-option key="C5" label="C5" value="C5"></el-option>
                            </el-select>
                        </el-form-item>
                    </td>
                </tr>
        ...
        <div style="margin-top:1%;margin-bottom:1%;margin-top: 20px;    margin-left: 100px; ">
            <el-row :gutter="200">
                <el-col :span="4"style="margin-left: 10px">
                    ...
                    <div style="width: 250px;text-align: center;">*驾驶证首页</div>
                </el-col>
                <el-col :span="4"style="margin-left: 90px">
                    ...
                    <div style="width: 250px;text-align: center;">*驾驶证次页</div>
                </el-col>
               <!-- <el-col :span="4"style="margin-left: 90px">
                    <el-upload
                            class="avatar-uploader"
    ...
    export default {
        ...
        methods:{
            ...
            addTdriverForm() {
                ...
                let url = "/api/regulatory/DriverM/addDriver";
                var str = '';
                if(self.ruleType == 2){
                    str = 5;
                ...
                self.$axios
                    .post(url, {
                        ...
                        driveLevel: self.driverForm.driveLevel
                    })
                    .then(function(res) {
                        if (res.code == 0) {
                            self.$message.success("保存司机信息成功!");
                            self.closePage()
                        }else{
                    ...
                    .catch(function(err) {
                        self.$message.error("保存司机信息失败，请稍后再试!");
                        // self.closePage()
                    });
            },
            ...
            updateTdriverForm() {
                ...
                self.$axios
                    ...
                    .catch(function(err) {
                        self.$message.error("编辑司机信息失败，请稍后再试!");
                        self.closePage()
                    });
            },
