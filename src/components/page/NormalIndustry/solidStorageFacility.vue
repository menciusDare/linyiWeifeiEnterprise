<template>
    ...
    <div class="main">
            ...
            <div class="panel-bd">
                ...
                <div style="padding: 20px 0px 0 2px;">
                    <ul class="filter-box">
                        <li class="filter-item">
                            <div class="filter-label">贮存设施名称：</div>
                            <div class="filter-con">
                                <div class="el-input w180 el-input-group el-input--prefix">
                                    <input type="text" autocomplete="off" placeholder="贮存设施名称" v-model="search.facilitiesName" class="el-input__inner" >
                                </div>
                            </div>
                        </li>

                        <li class="filter-item">
                            <div class="filter-label">贮存设施类型：</div>
                            <div class="filter-con">
                        ...
                        <li class="filter-item">
                            <div class="filter-btn" >
                              <!--  <button type="button" @click="insertStorage" class="button-type"><span>新增贮存设施</span></button>-->
                ...
                <table class="table-default table-full">
                    ...
                    <tr>
                        ...
                        <th style="text-align:center;width: 10%">贮存设施</th>
                        <th style="text-align:center;width: 10%">贮存设施类型</th>
                    ...
                    <tr v-for="(item,index) in dataList" :key="index">
                        ...
                        <td style="text-align:center;text-overflow: ellipsis;white-space:nowrap;overflow:hidden;width: 10%" >
                            <div class="btn-opreate">
                                ...
                                <a @click="updateStorage2(item)" href="javascript:;" class="text-primary text-underline">查看</a>
            ...
            <el-dialog :modal-append-to-body="false" :close-on-click-modal="false" :title="titleName" top="9vh" :visible.sync="dialogVisible" width="800px" @close="closeDia">
                <div>
                    <el-form ref="formFacilities" label-width="150px" :model="formFacilities" :rules="listRules">
                        <tr>
                            <td>
                                <el-form-item label="贮存设施名称：" prop="facilitiesName" :rules="listRules.facilitiesName">
                                    <el-input v-model="formFacilities.facilitiesName" style="width: 200px" placeholder="请输入贮存设施名称" :readonly="operationType == 3?true:false"></el-input>
                                </el-form-item>
                            </td>
                            <td>
                                <el-form-item label="贮存设施类型：" prop="storageType" :rules="listRules.storageType">
                                    <el-select v-model="formFacilities.storageType" style="width: 200px" placeholder="请选择贮存设施类型" :disabled="operationType == 3?true:false">
                                        <el-option
                        ...
                        <tr>
                            <td>
                                <el-form-item label="贮存设施大小：" prop="area"  :rules="listRules.area">
                                    <el-input v-model="formFacilities.area" style="width: 200px" placeholder="请输入贮存设施大小" :readonly="operationType == 3?true:false"></el-input>
                                </el-form-item>
                            </td>
                            <td>
                                <el-form-item label="贮存设施大小单位：" prop="areaType" :rules="listRules.areaType">
                                    <el-select v-model="formFacilities.areaType" style="width: 200px" placeholder="请选择贮存设施大小单位" :disabled="operationType == 3?true:false">
                                        <el-option
                        ...
                        <tr>
                            <td>
                                <el-form-item label="贮存能力：" prop="maxAmount" :rules="listRules.maxAmount">
                            ...
                            <td>
                                <el-form-item label="贮存能力单位：" prop="lng" >
                                     <el-input  style="width: 100%" placeholder="吨" :disabled="true" :title="吨"></el-input>
                        ...
                        <tr>
                            <!-- <td>
                                   <el-form-item label="计划贮存的固废：" prop="personLiable" :rules="listRules.personLiable">
                                
                                 <el-select v-model="formFacilities.personLiable" style="width: 200px" placeholder="请选择" :disabled="operationType == 3?true:false">
                                        <el-option
                                                v-for="item in planStorageWasteList"
                                                :key="item.value"
                                                :label="item.label"
                                                :value="item.value">
                                        </el-option>
                            ...
                            <td>
                                  <el-form-item label="贮存设施地址：" prop="address" :rules="listRules.address">
                                    <el-input v-model="formFacilities.address" style="width:100%" placeholder="请输入" :readonly="operationType == 3?true:false"></el-input>
                                </el-form-item>
                        ...
                        <tr>
                                <td >
                                <el-form-item label="设施是否符合GB18599标准：" prop="meetStandard" :rules="listRules.meetStandard">
                                      <el-select v-model="formFacilities.meetStandard" style="width: 200px" placeholder="请选择" :disabled="operationType == 3?true:false">
                                        <el-option
                                ...
                                <el-form-item label="备注：" prop="remark" >
                                    <el-input v-model="formFacilities.remark" style="100%"  placeholder="请输入备注" :readonly="operationType == 3?true:false"></el-input>
                                </el-form-item>
                            </td>
                            <!-- <td colspan="2">
                        ...
                        <tr><td colspan="2" style="text-align:center"><p style="font-size:12px;color:red;"> 注:要有仓库的内外照片和危险标志图片,只能上传.jpg/.jpeg/.gif/.png格式的文件,附件会自动在信息保存时上传</p></td></tr>
                  <br>
                  <br>
                   <br>
                    </el-form>
                    <div slot="footer" class="dialog-footer" style="text-align: center;">
                       ...
                       <el-dialog :modal-append-to-body="false" :close-on-click-modal="false" :title="titleName" top="9vh" :visible.sync="dialogVisible2" width="800px" @close="closeDia">
                <div>
                    <el-form ref="formFacilities" label-width="150px" :model="formFacilities" :rules="listRules">
                        <tr>
                            <td>
                                <el-form-item label="贮存设施名称：" prop="facilitiesName" :rules="listRules.facilitiesName">
                                    <el-input v-model="formFacilities.facilitiesName"  style="width: 200px" placeholder="请输入贮存设施名称" :disabled="true"></el-input>
                                </el-form-item>
                            </td>
                            <td>
                                <el-form-item label="贮存设施类型：" prop="storageType" :rules="listRules.storageType">
                                    <el-select v-model="formFacilities.storageType" style="width: 200px" placeholder="请选择贮存设施类型" :disabled="true">
                                        <el-option
                                                v-for="item in storageTypes"
                                                :key="item.value"
                                                :label="item.label"
                        ...
                        <tr>
                            <td>
                                <el-form-item label="贮存设施大小：" prop="area"  :rules="listRules.area">
                                    <el-input v-model="formFacilities.area" style="width: 200px" placeholder="请输入贮存设施大小" :disabled="true"></el-input>
                                </el-form-item>
                            </td>
                            <td>
                                <el-form-item label="贮存设施大小单位：" prop="areaType" :rules="listRules.areaType">
                                    <el-select v-model="formFacilities.areaType" style="width: 200px" placeholder="请选择贮存设施大小单位" :disabled="true">
                                        <el-option
                                                v-for="item in areaTypes"
                                                :key="item.value"
                                                :label="item.label"
                        ...
                        <tr>
                            <td>
                                <el-form-item label="贮存能力：" prop="maxAmount" :rules="listRules.maxAmount">
                                    <el-input v-model="formFacilities.maxAmount" disabled style="width: 200px" placeholder="请输入贮存能力" :readonly="true"></el-input>
                                </el-form-item>
                            </td>
                            <td>
                                <el-form-item label="贮存能力单位：" prop="lng" >
                        ...
                        <tr>
                            <!-- <td>
                                 ...
                                 <el-select v-model="formFacilities.personLiable" style="width: 200px" placeholder="请选择" :disabled="true">
                                        <el-option
                                                v-for="item in planStorageWasteList"
                                                :key="item.value"
                                                :label="item.label"
                            ...
                            <td>
                                  <el-form-item label="贮存设施地址：" prop="address" :rules="listRules.address">
                                    <el-input v-model="formFacilities.address" style="width:100%" placeholder="请输入" :disabled="true"></el-input>
                                </el-form-item>
                                <!-- <el-form-item label="联系电话：" prop="phone" :rules="listRules.phone">
                                    <el-input v-model="formFacilities.phone" style="width: 200px" placeholder="请输入联系电话" :readonly="operationType == 3?true:false"></el-input>
                                </el-form-item> -->
                        ...
                        <tr>
                                <td >
                                <el-form-item label="设施是否符合GB18599标准：" prop="address" :rules="listRules.meetStandard">
                                      <el-select v-model="formFacilities.meetStandard" style="width: 200px" placeholder="请选择" :disabled="true">
                                        <el-option
                                                v-for="item in YesNoList"
                                                :key="item.value"
                                                :label="item.label"
                                   ...
                                   <td >
                                <el-form-item label="备注：" prop="remark" >
                                    <el-input v-model="formFacilities.remark" :disabled="true" style="100%"  placeholder="请输入备注" :readonly="operationType == 3?true:false"></el-input>
                                </el-form-item>
                            </td>
                            <!-- <td colspan="2">
                                <el-form-item label="地址：" prop="address" :rules="listRules.address">
                            ...
                            <td colspan="2">
                                <el-form-item label="图片：">
                                    <el-upload
                                            ...
                                            :on-remove="handleRemove"
                                            :on-success="onSuccessImg"
                                            :file-list="fileList" :disabled="true" prop= "">
                                        <i class="el-icon-plus" ></i>
                                    </el-upload>
                                    <el-dialog :visible.sync="dialogVisibleImg" :modal="false" :disabled="true" :modal-append-to-body="false" title="大图" top="30px">
                                        <img width="100%" :src="dialogImageUrl" alt="">
                                    </el-dialog>
                                </el-form-item>
                            </td>
        ...
        <el-dialog  :modal-append-to-body="false" :close-on-click-modal="false" title="贮存设施详情" top="9vh" :visible.sync="dialogShowVisible" width="800px" @close="closeShowDia">
            <div>
                <!-- <el-row> -->
                    <!-- <el-col :span="12"><div class="grid-content bg-purple-light appeal" ><span>&nbsp;&nbsp;&nbsp;&nbsp;贮存设施名称：{{formFacilities.facilitiesName}}</span></div></el-col>
                    <el-col :span="12"><div class="grid-content bg-purple-light appeal"><span>&nbsp;&nbsp;&nbsp;&nbsp;贮存设施类型：{{forrmotName(storageTypes,formFacilities.storageType)}}</span></div></el-col>
                </el-row>
                <el-row>
                    <el-col :span="12"><div class="grid-content bg-purple appeal"><span>&nbsp;&nbsp;&nbsp;&nbsp;贮存设施大小：{{formFacilities.area}}</span></div></el-col>
                    <el-col :span="12"><div class="grid-content bg-purple appeal"><span>&nbsp;&nbsp;&nbsp;&nbsp;贮存设施大小单位：{{forrmotName(areaTypes,formFacilities.areaType)}}</span></div></el-col>
                </el-row>
                <el-row>
                ...
                <el-row>
                    <el-col :span="12"><div class="grid-content bg-purple-light appeal"><span>&nbsp;&nbsp;&nbsp;&nbsp;贮存能力：{{formFacilities.maxAmount}}</span></div></el-col>
                    <el-col :span="12"><div class="grid-content bg-purple-light appeal"><span>&nbsp;&nbsp;&nbsp;&nbsp;贮存能力单位：{{formatString(formFacilities.lng)+' ，'+formatString(formFacilities.lat)}}</span></div></el-col>
                </el-row>
                <el-row>
                    <!-- <el-col :span="12"><div class="grid-content bg-purple appeal"><span>&nbsp;&nbsp;&nbsp;&nbsp;计划贮存的固废：{{formFacilities.personLiable}}</span></div></el-col> -->
                    <el-col :span="12"><div class="grid-content bg-purple appeal"><span>&nbsp;&nbsp;&nbsp;&nbsp;贮存设施地址：{{formFacilities.phone}}</span></div></el-col>
                </el-row>
                <el-row>
                    <el-col :span="12"><div class="grid-content bg-purple-light appeal"><span>&nbsp;&nbsp;&nbsp;&nbsp;设施是否符合GB18599标准：{{formFacilities.meetStandard}}</span></div></el-col>
                     <el-col :span="12"><div class="grid-content bg-purple-light appeal"><span>&nbsp;&nbsp;&nbsp;&nbsp;备注：{{formFacilities.remark}}</span></div></el-col>
    ...
    export default {
        ...
        data(){
                        ...
                        function (res) {
                            if(res.code == 0){
                                if (!res.data) {
                                    ...
                                    return callback(new Error('贮存设施名称已存在，请重新输入！'));
                                }
                            }
                        }
                    ).catch((error) => {
            ...
            return {
                ...
                listRules:{
                    facilitiesName:[{required:true,message:'请输入贮存设施名称',trigger:'blur'},{validator: checkName, trigger: 'blur'}],
                    storageType:[{required:true,message:'请选择贮存设施类型',trigger:'change'}],
                    area:[{required:true,message:'请输入贮存设施大小',trigger:'blur'}],
                    areaType: [{required:true,message:'请选择贮存设施大小单位',trigger:'change'}],
                    ...
                    meetStandard:[{required:true,message:'请选择是否符合标准',trigger:'blur'}],
                    lng:[{required:false,message:'请选择储存能力单位',trigger:'blur'}],
                },
                bindDeviceRules:{
        ...
        methods: {
            ...
            updateBindDevice(){
                 this.$refs["deviceForm"].validate((valid) => {
                    if (valid) {
                       ...
                       getPlanStoreWasteList(){
                var _this=this;
                var params = new URLSearchParams();
                params.append('name', _this.search.vfName);       
                params.append('categoryId', _this.search.storageId);
                
                _this.$axios.get('/api/regulatory/commonlysolidwaste/wasteProductionList',{params}).then(
                    function (res) {
                        if(res.code == 0){
                            
                             _this.planStorageWasteList=res.data
            ...
            stopStorage(item){
                ...
                _this.$confirm(item.storageStatus == 1?'此操作将启用该贮存设施, 是否继续?':'此操作将停用该贮存设施, 是否继续?', '提示', {
